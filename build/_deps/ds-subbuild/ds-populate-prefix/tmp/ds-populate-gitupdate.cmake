...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "qds-4.1"
  WORKING_DIRECTORY "/Users/mason/Documents/Code/dash-cpp/build/_deps/ds-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("qds-4.1" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/qds-4.1")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"qds-4.1\" is not present locally, and not "
